![docker image](https://github.com/nomad-hzb/nomad-pvcomb/actions/workflows/docker-publish.yml/badge.svg)
...
```sh
curl -L -o nomad-oasis.zip "https://github.com/nomad-hzb/nomad-pvcomb/raw/main/nomad-oasis.zip"
```
...
your `docker-compose.yaml` with `ghcr.io/nomad-hzb/nomad-pvcomb:main` for the services
 ...
 *I get an* `Error response from daemon: Head "https://ghcr.io/v2/nomad-hzb/nomad-pvcomb/manifests/main": unauthorized`
